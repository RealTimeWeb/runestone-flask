...
project = u'<Python in Context>' # e.g. How To Think Like a Computer Scientist
copyright = u'<2014, Austin Cory Bart>' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "Python in Context",
...
html_title = 'Python in Context'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Python in Context'
